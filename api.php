...
function defaultDictionaries(): array {
    return [
        'it' => [
            ...
            'teams_page_title' => 'Gestione Squadre',
            'teams_total' => 'Totale',
            'team_confirmed' => 'Confermata',
            'team_dummy' => 'Fittizia',
            'team_avg_level' => 'Media livello',
            'team_no_players' => 'Giocatori non inseriti',
            'bar_title' => '🍹 Bar del Torneo',
            'fullscreen_shrink' => 'Torna alla visualizzazione ridotta',
            'fullscreen_expand' => 'Visualizza a schermo intero',
            'add_to_cart' => 'Aggiungi',
            'cart_title' => '🛒 Il tuo carrello',
            'cart_empty' => 'Il carrello è vuoto. Aggiungi qualcosa dal menu qui sopra!',
            'cart_each' => 'cad.',
            'cart_total' => 'Totale',
            'your_name_label' => 'Il tuo nome',
            'placeholder_name_surname' => 'Nome e cognome',
            'notes_optional_label' => 'Note (opzionale)',
            'placeholder_order_notes' => 'Es: senza ghiaccio',
            'pay_cash_order_button' => '💵 Ordina e paga in cassa',
            'newsletter_title' => '📬 Resta aggiornato',
            'newsletter_intro' => 'Iscriviti per essere contattato con aggiornamenti sul torneo, anche se non iscrivi una squadra. Basta uno tra email e telefono (puoi anche inserirli entrambi).',
            'label_email' => 'Email',
            'label_phone' => 'Telefono',
            'newsletter_submit' => 'Iscrivimi',
            'attendance_title' => '🎟️ Partecipa all\'evento',
            'attendance_intro' => 'Non giochi ma vuoi venire a vedere il torneo? Segnala la tua presenza qui, così sappiamo quante persone aspettarci.',
            'label_full_name' => 'Nome e cognome',
            'attendance_name_placeholder' => 'Il tuo nome',
            'attendance_total_people' => 'Quante persone in totale (te compreso/a)',
            'attendance_children' => 'Di cui quanti bambini',
            'attendance_submit' => 'Conferma partecipazione',
            'payment_title' => '💰 Paga la quota',
            'payment_select_team' => 'Seleziona la tua squadra',
            'payment_choose_team_option' => '-- Scegli la squadra --',
            'payment_who_paying' => 'Per chi stai pagando ora?',
            'payment_quota_selected' => 'Quota per i giocatori selezionati',
            'payment_pay_cash_button' => '💵 Pago in contanti all\'organizzatore',
            'contact_title' => '📞 Contatta l\'organizzazione',
            'contact_intro' => 'Per segnalare un problema, fare una richiesta o avere informazioni sul torneo.',
            'contact_no_contact' => 'Nessun contatto configurato dall\'organizzazione.',
            'contact_email_subject' => 'Segnalazione / richiesta - ',
            'contact_email_body' => 'Ciao,

Scrivo in merito a (bug riscontrato / richiesta / altro):

',
            'contact_write_email' => 'Scrivi una email',
            'contact_call' => 'Chiama',
            'contact_write_whatsapp' => 'Scrivi su WhatsApp',
            'payment_default_description' => 'Ogni giocatore è invitato a contribuire con un\'offerta di € {amount} per aiutarci a coprire i costi del torneo (campi, arbitri, ristoro). Grazie di cuore!',
            'payment_already_paid_suffix' => '(già pagato)',
            'payment_already_paid_msg' => '✅ Questa squadra ha già saldato la quota, grazie!',
            'payment_players_selected_label' => 'giocatori selezionati',
            'payment_quota_label' => 'Quota',
            'payment_cash_label' => 'In contanti',
            'payment_with_paypal_label' => 'con PayPal',
            'payment_paypal_fee_tooltip' => 'La commissione PayPal (3,4% + 0,35€) viene aggiunta solo se paghi online, così l\'organizzatore riceve l\'intera quota',
            'payment_includes_fee_text' => 'include € {fee} di commissione PayPal',
            'validation_email_or_phone_required' => 'Inserisci almeno un\'email o un numero di telefono.',
            'validation_email_invalid' => 'Email non valida.',
            'validation_phone_invalid' => 'Numero di telefono non valido.',
            'validation_privacy_required' => 'Devi accettare l\'informativa privacy.',
            'newsletter_already_registered' => '✅ Sei già iscritto — contatti aggiornati.',
            'newsletter_success' => '✅ Iscrizione avvenuta con successo!',
            'validation_name_required' => 'Inserisci il tuo nome.',
            'validation_email_required_valid' => 'Inserisci un\'email valida.',
            'validation_phone_required_valid' => 'Inserisci un numero di telefono valido.',
            'attendance_min_people' => 'Il numero di persone deve essere almeno 1.',
            'attendance_children_exceed' => 'Il numero di bambini non può superare il numero totale di persone.',
            'attendance_success' => '✅ Presenza confermata, grazie!',
            'attendance_spots_full' => '⚠️ Posti esauriti, non è più possibile confermare nuove presenze.',
            'attendance_spots_remaining' => 'Posti ancora disponibili',
            'payment_cash_confirmation_msg' => 'Perfetto, consegna la quota direttamente all\'organizzatore in loco — sarà lui a registrare il pagamento per i giocatori selezionati.',
            'payment_success_msg' => '✅ Pagamento completato, grazie mille!',
            'payment_success_but_register_error' => 'Pagamento riuscito ma errore nel registrarlo:',
            'paypal_generic_error' => 'Si è verificato un errore con PayPal. Puoi comunque pagare in contanti.',
            'paypal_unavailable' => 'PayPal non disponibile al momento. Puoi pagare in contanti.',
            'validation_name_for_order' => 'Inserisci il tuo nome per procedere con l\'ordine.',
            'cart_empty_alert' => 'Il carrello è vuoto.',
            'order_error_prefix' => 'Errore:',
            'order_send_failed' => 'invio ordine fallito',
            'order_sent_message' => 'Grazie {name}! Il tuo ordine è stato ricevuto.

Presentati in cassa per pagare e ritirare (totale: € {total}).',
            'order_sent_title' => '✅ Ordine inviato',
            'order_send_error_prefix' => 'Errore invio ordine:',
            'validation_name_before_paypal' => 'Inserisci il tuo nome prima di pagare con PayPal.',
            'bar_paypal_success_message' => 'Grazie {name}! Il pagamento PayPal è andato a buon fine, il tuo ordine è confermato.',
            'bar_paypal_success_title' => '✅ Pagamento completato',
            'bar_paypal_success_but_register_error' => 'Pagamento riuscito ma errore nel registrare l\'ordine:',
            'bar_paypal_show_receipt' => 'Mostra la ricevuta PayPal in cassa.',
            'bar_paypal_generic_error' => 'Si è verificato un errore con PayPal. Puoi comunque ordinare e pagare in cassa.',
            'bar_paypal_unavailable' => 'PayPal non disponibile al momento. Usa "Ordina e paga in cassa".',
            'groups_page_title' => '📊 Gironi e Fasi',
            'groups_not_published' => 'Gironi non ancora pubblicati.',
            'groups_not_published_phase' => 'Gironi non ancora pubblicati per questa fase.',
            'phase_generic_name' => 'Fase',
            'tab_groups' => 'Gironi',
            'tab_matches' => 'Partite',
            'tab_standings' => 'Classifiche',
            'group_label' => 'Girone',
            'level_label_prefix' => 'Livello',
            'schedule_title' => 'Calendario',
            'matches_not_available' => 'Partite non disponibili.',
            'matches_title' => '🏆 Calendario partite',
            'filter_by_team' => '🔎 Filtra per squadra:',
            'all_teams_option' => 'Tutte le squadre',
            'no_matches_for_team' => 'Nessuna partita trovata per la squadra selezionata.',
            'table_header_group' => 'Girone',
            'table_header_date' => 'Data',
            'table_header_time' => 'Ora',
            'table_header_phase' => 'Fase',
            'table_header_match' => 'Match',
            'table_header_result' => 'Risultato',
            'scoreboard_button' => '📺 Tabellone',
            'standings_title_knockout' => '📈 Classifica',
            'standings_title_groups' => '📈 Classifiche Gironi',
            'standings_not_available' => 'Classifiche non ancora disponibili.',
            'knockout_no_standings_intro' => 'Questa è una fase a eliminazione diretta: non esiste una classifica nel senso classico. Ecco come è stato costruito il tabellone:',
            'knockout_sort_criterion' => '📊 Criterio di ordinamento delle squadre:',
            'knockout_avoid_rematch' => '🚫 Evita rematch dello stesso girone al primo turno:',
            'knockout_maximize_seed' => '🌟 Teste di serie il più lontano possibile:',
            'knockout_bracket_note' => 'Il tabellone e i risultati delle partite si trovano nella scheda "🏆 Partite" / "Fase finale".',
            'yes_label' => 'Sì',
            'no_label' => 'No',
            'criterion_avg_points' => 'Media Punti per Partita',
            'criterion_win_pct' => '% Vittorie',
            'criterion_avg_quotient_diff' => 'Media + Quoziente + Diff',
            'standings_col_pos' => 'Pos',
            'standings_col_team' => 'Squadra',
            'standings_col_pt' => 'Pt',
            'standings_col_played' => 'G',
            'standings_col_won' => 'V',
            'standings_col_drawn' => 'N',
            'standings_col_lost' => 'S',
            'standings_col_scored_soccer' => 'GF',
            'standings_col_conceded_soccer' => 'GS',
            'standings_col_scored_volley' => 'PF',
            'standings_col_conceded_volley' => 'PS',
            'standings_col_diff' => 'Diff',
            'teams_advance_per_group' => 'squadre passano per girone',
            'gallery_loading' => 'Caricamento foto...',
            'gallery_load_error' => 'Errore caricamento galleria',
            'gallery_connection_error' => 'Errore di connessione',
            'gallery_title' => '📸 Galleria',
            'gallery_empty' => 'Nessuna foto pubblicata al momento.',
            'gallery_prev_photo' => 'Foto precedente',
            'gallery_next_photo' => 'Foto successiva',
            'gallery_close_button' => 'Chiudi',
            'final_phase_title' => 'Fase finale',
            'final_phase_not_generated' => 'Fase finale non ancora generata.',
            'team1_label' => 'Squadra 1',
            'team2_label' => 'Squadra 2',
            'final_ranking_title' => 'Classifica finale',
            'final_ranking_not_available' => 'Ranking finale non disponibile.',
            'position_label' => 'Posizione',
            'tablescore_start' => '▶️ Avvia',
            'tablescore_reset' => '🔄 Reset',
            'tablescore_use_timeout' => 'USA TIMEOUT',
            'tablescore_next_set' => '⏭️ PROSSIMO SET',
            'tablescore_reset_set' => '🔄 RESET SET',
            'tablescore_next_half' => '⏭️ PROSSIMO TEMPO',
            'tablescore_reset_half' => '🔄 RESET TEMPO',
            'tablescore_whistle' => '🔊 FISCHIO ARBITRO',
            'tablescore_horn' => '📯 TROMBA FINE PARTITA',
            'tablescore_pause' => '⏸️ Pausa',
            'tablescore_match_not_found' => 'Errore: Partita non trovata',
            'tablescore_load_error' => 'Errore caricamento partita:',
            ...
            'print_studio_include_name' => 'Mostra il nome del torneo sulla foto',
            'print_studio_no_frame' => '🚫 Nessuna cornice',
            'print_studio_drag_hint' => '👆 Trascina la foto per spostarla dentro la cornice',
            'print_studio_center' => '🎯 Centra',
            ...
            'nav_team_voting' => 'Vota la tua Squadra',
        ...
        'en' => [
            ...
            'teams_total' => 'Total',
            'team_confirmed' => 'Confirmed',
            'team_dummy' => 'Dummy',
            'team_avg_level' => 'Average level',
            'team_no_players' => 'No players entered',
            'bar_title' => '🍹 Tournament Bar',
            'fullscreen_shrink' => 'Back to compact view',
            'fullscreen_expand' => 'View fullscreen',
            'add_to_cart' => 'Add',
            'cart_title' => '🛒 Your cart',
            'cart_empty' => 'Your cart is empty. Add something from the menu above!',
            'cart_each' => 'each',
            'cart_total' => 'Total',
            'your_name_label' => 'Your name',
            'placeholder_name_surname' => 'First and last name',
            'notes_optional_label' => 'Notes (optional)',
            'placeholder_order_notes' => 'E.g. no ice',
            'pay_cash_order_button' => '💵 Order and pay at the counter',
            'newsletter_title' => '📬 Stay updated',
            'newsletter_intro' => 'Sign up to be contacted with tournament updates, even if you don\'t register a team. Just email or phone is enough (you can enter both).',
            'label_email' => 'Email',
            'label_phone' => 'Phone',
            'newsletter_submit' => 'Sign me up',
            'attendance_title' => '🎟️ Attend the event',
            'attendance_intro' => 'Not playing but want to come watch the tournament? Let us know you\'re coming here, so we know how many people to expect.',
            'label_full_name' => 'Full name',
            'attendance_name_placeholder' => 'Your name',
            'attendance_total_people' => 'How many people in total (including you)',
            'attendance_children' => 'Of which how many children',
            'attendance_submit' => 'Confirm attendance',
            'payment_title' => '💰 Pay the fee',
            'payment_select_team' => 'Select your team',
            'payment_choose_team_option' => '-- Choose your team --',
            'payment_who_paying' => 'Who are you paying for now?',
            'payment_quota_selected' => 'Fee for the selected players',
            'payment_pay_cash_button' => '💵 I\'ll pay in cash at the organizer',
            'contact_title' => '📞 Contact the organization',
            'contact_intro' => 'To report an issue, make a request, or get information about the tournament.',
            'contact_no_contact' => 'No contact configured by the organization.',
            'contact_email_subject' => 'Report / request - ',
            'contact_email_body' => 'Hi,

I\'m writing about (bug found / request / other):

',
            'contact_write_email' => 'Write an email',
            'contact_call' => 'Call',
            'contact_write_whatsapp' => 'Write on WhatsApp',
            'payment_default_description' => 'Every player is invited to contribute € {amount} to help cover tournament costs (courts, referees, refreshments). Thank you so much!',
            'payment_already_paid_suffix' => '(already paid)',
            'payment_already_paid_msg' => '✅ This team has already paid the fee, thank you!',
            'payment_players_selected_label' => 'players selected',
            'payment_quota_label' => 'Fee',
            'payment_cash_label' => 'Cash',
            'payment_with_paypal_label' => 'with PayPal',
            'payment_paypal_fee_tooltip' => 'The PayPal fee (3.4% + €0.35) is only added if you pay online, so the organizer receives the full fee',
            'payment_includes_fee_text' => 'includes € {fee} PayPal fee',
            'validation_email_or_phone_required' => 'Enter at least an email or a phone number.',
            'validation_email_invalid' => 'Invalid email.',
            'validation_phone_invalid' => 'Invalid phone number.',
            'validation_privacy_required' => 'You must accept the privacy policy.',
            'newsletter_already_registered' => '✅ You\'re already signed up — contact details updated.',
            'newsletter_success' => '✅ Successfully signed up!',
            'validation_name_required' => 'Enter your name.',
            'validation_email_required_valid' => 'Enter a valid email.',
            'validation_phone_required_valid' => 'Enter a valid phone number.',
            'attendance_min_people' => 'The number of people must be at least 1.',
            'attendance_children_exceed' => 'The number of children cannot exceed the total number of people.',
            'attendance_success' => '✅ Attendance confirmed, thank you!',
            'attendance_spots_full' => '⚠️ No spots left, new attendances can no longer be confirmed.',
            'attendance_spots_remaining' => 'Spots still available',
            'payment_cash_confirmation_msg' => 'Great, hand the fee directly to the organizer on site — they\'ll register the payment for the selected players.',
            'payment_success_msg' => '✅ Payment completed, thank you so much!',
            'payment_success_but_register_error' => 'Payment succeeded but there was an error registering it:',
            'paypal_generic_error' => 'A PayPal error occurred. You can still pay in cash.',
            'paypal_unavailable' => 'PayPal is currently unavailable. You can pay in cash.',
            'validation_name_for_order' => 'Enter your name to proceed with the order.',
            'cart_empty_alert' => 'Your cart is empty.',
            'order_error_prefix' => 'Error:',
            'order_send_failed' => 'order submission failed',
            'order_sent_message' => 'Thank you {name}! Your order has been received.

Come to the counter to pay and pick up (total: € {total}).',
            'order_sent_title' => '✅ Order sent',
            'order_send_error_prefix' => 'Error sending order:',
            'validation_name_before_paypal' => 'Enter your name before paying with PayPal.',
            'bar_paypal_success_message' => 'Thank you {name}! The PayPal payment was successful, your order is confirmed.',
            'bar_paypal_success_title' => '✅ Payment completed',
            'bar_paypal_success_but_register_error' => 'Payment succeeded but there was an error registering the order:',
            'bar_paypal_show_receipt' => 'Show the PayPal receipt at the counter.',
            'bar_paypal_generic_error' => 'A PayPal error occurred. You can still order and pay in cash.',
            'bar_paypal_unavailable' => 'PayPal is currently unavailable. Use "Order and pay at the counter".',
            'groups_page_title' => '📊 Groups & Phases',
            'groups_not_published' => 'Groups not published yet.',
            'groups_not_published_phase' => 'Groups not published yet for this phase.',
            'phase_generic_name' => 'Phase',
            'tab_groups' => 'Groups',
            'tab_matches' => 'Matches',
            ...
            'matches_not_available' => 'Matches not available.',
            'matches_title' => '🏆 Match schedule',
            'filter_by_team' => '🔎 Filter by team:',
            'all_teams_option' => 'All teams',
            'no_matches_for_team' => 'No matches found for the selected team.',
            'table_header_group' => 'Group',
            'table_header_date' => 'Date',
            'table_header_time' => 'Time',
            'table_header_phase' => 'Phase',
            'table_header_match' => 'Match',
            'table_header_result' => 'Result',
            'scoreboard_button' => '📺 Scoreboard',
            'standings_title_knockout' => '📈 Standings',
            'standings_title_groups' => '📈 Group standings',
            'standings_not_available' => 'Standings not available yet.',
            'knockout_no_standings_intro' => 'This is a knockout phase: there\'s no standings table in the classic sense. Here\'s how the bracket was built:',
            'knockout_sort_criterion' => '📊 Team ranking criterion:',
            'knockout_avoid_rematch' => '🚫 Avoid same-group rematches in the first round:',
            'knockout_maximize_seed' => '🌟 Keep seeds as far apart as possible:',
            'knockout_bracket_note' => 'The bracket and match results can be found in the "🏆 Matches" / "Final phase" tab.',
            'yes_label' => 'Yes',
            'no_label' => 'No',
            'criterion_avg_points' => 'Average Points per Match',
            'criterion_win_pct' => 'Win %',
            'criterion_avg_quotient_diff' => 'Average + Quotient + Diff',
            'standings_col_pos' => 'Pos',
            'standings_col_team' => 'Team',
            'standings_col_pt' => 'Pts',
            'standings_col_played' => 'P',
            'standings_col_won' => 'W',
            'standings_col_drawn' => 'D',
            'standings_col_lost' => 'L',
            'standings_col_scored_soccer' => 'GF',
            'standings_col_conceded_soccer' => 'GA',
            'standings_col_scored_volley' => 'PF',
            'standings_col_conceded_volley' => 'PA',
            'standings_col_diff' => 'Diff',
            'teams_advance_per_group' => 'teams advance per group',
            'gallery_loading' => 'Loading photos...',
            'gallery_load_error' => 'Error loading gallery',
            'gallery_connection_error' => 'Connection error',
            'gallery_title' => '📸 Gallery',
            'gallery_empty' => 'No photos published yet.',
            'gallery_prev_photo' => 'Previous photo',
            'gallery_next_photo' => 'Next photo',
            'gallery_close_button' => 'Close',
            'final_phase_title' => 'Final phase',
            'final_phase_not_generated' => 'Final phase not generated yet.',
            'team1_label' => 'Team 1',
            'team2_label' => 'Team 2',
            'final_ranking_title' => 'Final standings',
            'final_ranking_not_available' => 'Final ranking not available.',
            'position_label' => 'Position',
            'tablescore_start' => '▶️ Start',
            'tablescore_reset' => '🔄 Reset',
            'tablescore_use_timeout' => 'USE TIMEOUT',
            'tablescore_next_set' => '⏭️ NEXT SET',
            'tablescore_reset_set' => '🔄 RESET SET',
            'tablescore_next_half' => '⏭️ NEXT HALF',
            'tablescore_reset_half' => '🔄 RESET HALF',
            'tablescore_whistle' => '🔊 REFEREE WHISTLE',
            'tablescore_horn' => '📯 END OF MATCH HORN',
            'tablescore_pause' => '⏸️ Pause',
            'tablescore_match_not_found' => 'Error: Match not found',
            'tablescore_load_error' => 'Error loading match:',
            ...
            'print_studio_include_name' => 'Show the tournament name on the photo',
            'print_studio_no_frame' => '🚫 No frame',
            'print_studio_drag_hint' => '👆 Drag the photo to move it inside the frame',
            'print_studio_center' => '🎯 Center',
            ...
            'nav_team_voting' => 'Vote Your Team',
        ...
        'fr' => [
            ...
            'teams_page_title' => 'Gestion des équipes',
            'teams_total' => 'Total',
            'team_confirmed' => 'Confirmée',
            'team_dummy' => 'Fictive',
            'team_avg_level' => 'Niveau moyen',
            'team_no_players' => 'Aucun joueur saisi',
            'bar_title' => '🍹 Bar du Tournoi',
            'fullscreen_shrink' => 'Revenir à la vue réduite',
            'fullscreen_expand' => 'Afficher en plein écran',
            'add_to_cart' => 'Ajouter',
            'cart_title' => '🛒 Votre panier',
            'cart_empty' => 'Votre panier est vide. Ajoutez quelque chose depuis le menu ci-dessus !',
            'cart_each' => 'chacun',
            'cart_total' => 'Total',
            'your_name_label' => 'Votre nom',
            'placeholder_name_surname' => 'Nom et prénom',
            'notes_optional_label' => 'Notes (facultatif)',
            'placeholder_order_notes' => 'Ex : sans glace',
            'pay_cash_order_button' => '💵 Commander et payer en espèces',
            'newsletter_title' => '📬 Restez informé',
            'newsletter_intro' => 'Inscrivez-vous pour être contacté avec les mises à jour du tournoi, même sans inscrire d\'équipe. Un email ou un téléphone suffit (vous pouvez aussi indiquer les deux).',
            'label_email' => 'Email',
            'label_phone' => 'Téléphone',
            'newsletter_submit' => 'M\'inscrire',
            'attendance_title' => '🎟️ Participer à l\'événement',
            'attendance_intro' => 'Vous ne jouez pas mais voulez venir voir le tournoi ? Signalez votre présence ici, pour que nous sachions combien de personnes attendre.',
            'label_full_name' => 'Nom et prénom',
            'attendance_name_placeholder' => 'Votre nom',
            'attendance_total_people' => 'Combien de personnes au total (vous inclus)',
            'attendance_children' => 'Dont combien d\'enfants',
            'attendance_submit' => 'Confirmer la participation',
            'payment_title' => '💰 Payer la cotisation',
            'payment_select_team' => 'Sélectionnez votre équipe',
            'payment_choose_team_option' => '-- Choisissez l\'équipe --',
            'payment_who_paying' => 'Pour qui payez-vous maintenant ?',
            'payment_quota_selected' => 'Cotisation pour les joueurs sélectionnés',
            'payment_pay_cash_button' => '💵 Je paie en espèces à l\'organisateur',
            'contact_title' => '📞 Contacter l\'organisation',
            'contact_intro' => 'Pour signaler un problème, faire une demande ou obtenir des informations sur le tournoi.',
            'contact_no_contact' => 'Aucun contact configuré par l\'organisation.',
            'contact_email_subject' => 'Signalement / demande - ',
            'contact_email_body' => 'Bonjour,

Je vous écris à propos de (bug rencontré / demande / autre) :

',
            'contact_write_email' => 'Écrire un email',
            'contact_call' => 'Appeler',
            'contact_write_whatsapp' => 'Écrire sur WhatsApp',
            'payment_default_description' => 'Chaque joueur est invité à contribuer avec une offre de {amount} € pour nous aider à couvrir les frais du tournoi (terrains, arbitres, rafraîchissements). Merci beaucoup !',
            'payment_already_paid_suffix' => '(déjà payé)',
            'payment_already_paid_msg' => '✅ Cette équipe a déjà réglé la cotisation, merci !',
            'payment_players_selected_label' => 'joueurs sélectionnés',
            'payment_quota_label' => 'Cotisation',
            'payment_cash_label' => 'En espèces',
            'payment_with_paypal_label' => 'avec PayPal',
            'payment_paypal_fee_tooltip' => 'Les frais PayPal (3,4 % + 0,35 €) ne sont ajoutés que si vous payez en ligne, afin que l\'organisateur reçoive la cotisation complète',
            'payment_includes_fee_text' => 'inclut {fee} € de frais PayPal',
            'validation_email_or_phone_required' => 'Indiquez au moins un email ou un numéro de téléphone.',
            'validation_email_invalid' => 'Email invalide.',
            'validation_phone_invalid' => 'Numéro de téléphone invalide.',
            'validation_privacy_required' => 'Vous devez accepter la politique de confidentialité.',
            'newsletter_already_registered' => '✅ Vous êtes déjà inscrit — coordonnées mises à jour.',
            'newsletter_success' => '✅ Inscription réussie !',
            'validation_name_required' => 'Indiquez votre nom.',
            'validation_email_required_valid' => 'Indiquez un email valide.',
            'validation_phone_required_valid' => 'Indiquez un numéro de téléphone valide.',
            'attendance_min_people' => 'Le nombre de personnes doit être au moins 1.',
            'attendance_children_exceed' => 'Le nombre d\'enfants ne peut pas dépasser le nombre total de personnes.',
            'attendance_success' => '✅ Présence confirmée, merci !',
            'attendance_spots_full' => '⚠️ Places épuisées, il n\'est plus possible de confirmer de nouvelles présences.',
            'attendance_spots_remaining' => 'Places encore disponibles',
            'payment_cash_confirmation_msg' => 'Parfait, remettez la cotisation directement à l\'organisateur sur place — il enregistrera le paiement pour les joueurs sélectionnés.',
            'payment_success_msg' => '✅ Paiement effectué, merci beaucoup !',
            'payment_success_but_register_error' => 'Paiement réussi mais erreur lors de l\'enregistrement :',
            'paypal_generic_error' => 'Une erreur PayPal est survenue. Vous pouvez toujours payer en espèces.',
            'paypal_unavailable' => 'PayPal est actuellement indisponible. Vous pouvez payer en espèces.',
            'validation_name_for_order' => 'Indiquez votre nom pour continuer la commande.',
            'cart_empty_alert' => 'Votre panier est vide.',
            'order_error_prefix' => 'Erreur :',
            'order_send_failed' => 'échec de l\'envoi de la commande',
            'order_sent_message' => 'Merci {name} ! Votre commande a été reçue.

Présentez-vous à la caisse pour payer et récupérer (total : {total} €).',
            'order_sent_title' => '✅ Commande envoyée',
            'order_send_error_prefix' => 'Erreur lors de l\'envoi de la commande :',
            'validation_name_before_paypal' => 'Indiquez votre nom avant de payer avec PayPal.',
            'bar_paypal_success_message' => 'Merci {name} ! Le paiement PayPal a réussi, votre commande est confirmée.',
            'bar_paypal_success_title' => '✅ Paiement effectué',
            'bar_paypal_success_but_register_error' => 'Paiement réussi mais erreur lors de l\'enregistrement de la commande :',
            'bar_paypal_show_receipt' => 'Montrez le reçu PayPal à la caisse.',
            'bar_paypal_generic_error' => 'Une erreur PayPal est survenue. Vous pouvez toujours commander et payer en espèces.',
            'bar_paypal_unavailable' => 'PayPal est actuellement indisponible. Utilisez "Commander et payer en espèces".',
            'groups_page_title' => '📊 Groupes et Phases',
            'groups_not_published' => 'Groupes pas encore publiés.',
            'groups_not_published_phase' => 'Groupes pas encore publiés pour cette phase.',
            'phase_generic_name' => 'Phase',
            'tab_groups' => 'Groupes',
            'tab_matches' => 'Matchs',
            'tab_standings' => 'Classements',
            'group_label' => 'Groupe',
            'level_label_prefix' => 'Niveau',
            'schedule_title' => 'Calendrier',
            'matches_not_available' => 'Matchs non disponibles.',
            'matches_title' => '🏆 Calendrier des matchs',
            'filter_by_team' => '🔎 Filtrer par équipe :',
            'all_teams_option' => 'Toutes les équipes',
            'no_matches_for_team' => 'Aucun match trouvé pour l\'équipe sélectionnée.',
            'table_header_group' => 'Groupe',
            'table_header_date' => 'Date',
            'table_header_time' => 'Heure',
            'table_header_phase' => 'Phase',
            'table_header_match' => 'Match',
            'table_header_result' => 'Résultat',
            'scoreboard_button' => '📺 Tableau',
            'standings_title_knockout' => '📈 Classement',
            'standings_title_groups' => '📈 Classements des groupes',
            'standings_not_available' => 'Classements pas encore disponibles.',
            'knockout_no_standings_intro' => 'Il s\'agit d\'une phase à élimination directe : il n\'y a pas de classement au sens classique. Voici comment le tableau a été construit :',
            'knockout_sort_criterion' => '📊 Critère de classement des équipes :',
            'knockout_avoid_rematch' => '🚫 Éviter les rencontres du même groupe au premier tour :',
            'knockout_maximize_seed' => '🌟 Séparer les têtes de série autant que possible :',
            'knockout_bracket_note' => 'Le tableau et les résultats des matchs se trouvent dans l\'onglet "🏆 Matchs" / "Phase finale".',
            'yes_label' => 'Oui',
            'no_label' => 'Non',
            'criterion_avg_points' => 'Moyenne de points par match',
            'criterion_win_pct' => '% de victoires',
            'criterion_avg_quotient_diff' => 'Moyenne + Quotient + Diff',
            'standings_col_pos' => 'Pos',
            'standings_col_team' => 'Équipe',
            'standings_col_pt' => 'Pts',
            'standings_col_played' => 'J',
            'standings_col_won' => 'G',
            'standings_col_drawn' => 'N',
            'standings_col_lost' => 'P',
            'standings_col_scored_soccer' => 'BP',
            'standings_col_conceded_soccer' => 'BC',
            'standings_col_scored_volley' => 'PP',
            'standings_col_conceded_volley' => 'PC',
            'standings_col_diff' => 'Diff',
            'teams_advance_per_group' => 'équipes se qualifient par groupe',
            'gallery_loading' => 'Chargement des photos...',
            'gallery_load_error' => 'Erreur de chargement de la galerie',
            'gallery_connection_error' => 'Erreur de connexion',
            'gallery_title' => '📸 Galerie',
            'gallery_empty' => 'Aucune photo publiée pour le moment.',
            'gallery_prev_photo' => 'Photo précédente',
            'gallery_next_photo' => 'Photo suivante',
            'gallery_close_button' => 'Fermer',
            'final_phase_title' => 'Phase finale',
            'final_phase_not_generated' => 'Phase finale pas encore générée.',
            'team1_label' => 'Équipe 1',
            'team2_label' => 'Équipe 2',
            'final_ranking_title' => 'Classement final',
            'final_ranking_not_available' => 'Classement final non disponible.',
            'position_label' => 'Position',
            'tablescore_start' => '▶️ Démarrer',
            'tablescore_reset' => '🔄 Réinitialiser',
            'tablescore_use_timeout' => 'PRENDRE TEMPS MORT',
            'tablescore_next_set' => '⏭️ SET SUIVANT',
            'tablescore_reset_set' => '🔄 RÉINITIALISER LE SET',
            'tablescore_next_half' => '⏭️ MI-TEMPS SUIVANTE',
            'tablescore_reset_half' => '🔄 RÉINITIALISER LA MI-TEMPS',
            'tablescore_whistle' => '🔊 SIFFLET DE L\'ARBITRE',
            'tablescore_horn' => '📯 SIRÈNE DE FIN DE MATCH',
            'tablescore_pause' => '⏸️ Pause',
            'tablescore_match_not_found' => 'Erreur : Match introuvable',
            'tablescore_load_error' => 'Erreur de chargement du match :',
            ...
            'print_studio_include_name' => 'Afficher le nom du tournoi sur la photo',
            'print_studio_no_frame' => '🚫 Aucun cadre',
            'print_studio_drag_hint' => '👆 Faites glisser la photo pour la déplacer dans le cadre',
            'print_studio_center' => '🎯 Centrer',
            ...
            'nav_team_voting' => 'Votez votre Équipe',
        ...
        'de' => [
            ...
            'teams_page_title' => 'Team-Verwaltung',
            'teams_total' => 'Gesamt',
            'team_confirmed' => 'Bestätigt',
            'team_dummy' => 'Test-Team',
            'team_avg_level' => 'Durchschnittsniveau',
            'team_no_players' => 'Keine Spieler eingetragen',
            'bar_title' => '🍹 Turnier-Bar',
            'fullscreen_shrink' => 'Zurück zur kompakten Ansicht',
            'fullscreen_expand' => 'Vollbildansicht',
            'add_to_cart' => 'Hinzufügen',
            'cart_title' => '🛒 Dein Warenkorb',
            'cart_empty' => 'Dein Warenkorb ist leer. Füge etwas aus dem Menü oben hinzu!',
            'cart_each' => 'je Stück',
            'cart_total' => 'Gesamt',
            'your_name_label' => 'Dein Name',
            'placeholder_name_surname' => 'Vor- und Nachname',
            'notes_optional_label' => 'Notizen (optional)',
            'placeholder_order_notes' => 'Z. B. ohne Eis',
            'pay_cash_order_button' => '💵 Bestellen und bar bezahlen',
            'newsletter_title' => '📬 Bleib auf dem Laufenden',
            'newsletter_intro' => 'Melde dich an, um über Turnier-Updates informiert zu werden, auch ohne ein Team anzumelden. E-Mail oder Telefon genügt (du kannst auch beides angeben).',
            'label_email' => 'E-Mail',
            'label_phone' => 'Telefon',
            'newsletter_submit' => 'Anmelden',
            'attendance_title' => '🎟️ Am Event teilnehmen',
            'attendance_intro' => 'Du spielst nicht, möchtest aber das Turnier ansehen? Melde deine Anwesenheit hier an, damit wir wissen, mit wie vielen Personen wir rechnen können.',
            'label_full_name' => 'Vor- und Nachname',
            'attendance_name_placeholder' => 'Dein Name',
            'attendance_total_people' => 'Wie viele Personen insgesamt (dich eingeschlossen)',
            'attendance_children' => 'Davon wie viele Kinder',
            'attendance_submit' => 'Teilnahme bestätigen',
            'payment_title' => '💰 Gebühr bezahlen',
            'payment_select_team' => 'Wähle dein Team',
            'payment_choose_team_option' => '-- Team auswählen --',
            'payment_who_paying' => 'Für wen bezahlst du gerade?',
            'payment_quota_selected' => 'Gebühr für die ausgewählten Spieler',
            'payment_pay_cash_button' => '💵 Ich bezahle bar beim Veranstalter',
            'contact_title' => '📞 Organisation kontaktieren',
            'contact_intro' => 'Um ein Problem zu melden, eine Anfrage zu stellen oder Informationen zum Turnier zu erhalten.',
            'contact_no_contact' => 'Kein Kontakt von der Organisation eingerichtet.',
            'contact_email_subject' => 'Meldung / Anfrage - ',
            'contact_email_body' => 'Hallo,

Ich schreibe bezüglich (gefundener Fehler / Anfrage / Sonstiges):

',
            'contact_write_email' => 'E-Mail schreiben',
            'contact_call' => 'Anrufen',
            'contact_write_whatsapp' => 'Auf WhatsApp schreiben',
            'payment_default_description' => 'Jeder Spieler ist eingeladen, mit einem Beitrag von {amount} € zu den Turnierkosten beizutragen (Plätze, Schiedsrichter, Verpflegung). Vielen Dank!',
            'payment_already_paid_suffix' => '(bereits bezahlt)',
            'payment_already_paid_msg' => '✅ Dieses Team hat die Gebühr bereits bezahlt, danke!',
            'payment_players_selected_label' => 'Spieler ausgewählt',
            'payment_quota_label' => 'Gebühr',
            'payment_cash_label' => 'Bar',
            'payment_with_paypal_label' => 'mit PayPal',
            'payment_paypal_fee_tooltip' => 'Die PayPal-Gebühr (3,4 % + 0,35 €) wird nur bei Online-Zahlung hinzugefügt, damit der Veranstalter die volle Gebühr erhält',
            'payment_includes_fee_text' => 'inklusive {fee} € PayPal-Gebühr',
            'validation_email_or_phone_required' => 'Gib mindestens eine E-Mail oder eine Telefonnummer ein.',
            'validation_email_invalid' => 'Ungültige E-Mail.',
            'validation_phone_invalid' => 'Ungültige Telefonnummer.',
            'validation_privacy_required' => 'Du musst die Datenschutzerklärung akzeptieren.',
            'newsletter_already_registered' => '✅ Du bist bereits angemeldet — Kontaktdaten aktualisiert.',
            'newsletter_success' => '✅ Anmeldung erfolgreich!',
            'validation_name_required' => 'Gib deinen Namen ein.',
            'validation_email_required_valid' => 'Gib eine gültige E-Mail ein.',
            'validation_phone_required_valid' => 'Gib eine gültige Telefonnummer ein.',
            'attendance_min_people' => 'Die Anzahl der Personen muss mindestens 1 sein.',
            'attendance_children_exceed' => 'Die Anzahl der Kinder darf die Gesamtzahl der Personen nicht überschreiten.',
            'attendance_success' => '✅ Teilnahme bestätigt, danke!',
            'attendance_spots_full' => '⚠️ Plätze ausgebucht, neue Teilnahmen können nicht mehr bestätigt werden.',
            'attendance_spots_remaining' => 'Noch verfügbare Plätze',
            'payment_cash_confirmation_msg' => 'Perfekt, übergib die Gebühr direkt vor Ort dem Veranstalter — er wird die Zahlung für die ausgewählten Spieler registrieren.',
            'payment_success_msg' => '✅ Zahlung abgeschlossen, vielen Dank!',
            'payment_success_but_register_error' => 'Zahlung erfolgreich, aber Fehler bei der Registrierung:',
            'paypal_generic_error' => 'Ein PayPal-Fehler ist aufgetreten. Du kannst trotzdem bar bezahlen.',
            'paypal_unavailable' => 'PayPal ist derzeit nicht verfügbar. Du kannst bar bezahlen.',
            'validation_name_for_order' => 'Gib deinen Namen ein, um mit der Bestellung fortzufahren.',
            'cart_empty_alert' => 'Dein Warenkorb ist leer.',
            'order_error_prefix' => 'Fehler:',
            'order_send_failed' => 'Bestellung konnte nicht gesendet werden',
            'order_sent_message' => 'Danke {name}! Deine Bestellung wurde erhalten.

Komm zur Theke, um zu bezahlen und abzuholen (Gesamt: {total} €).',
            'order_sent_title' => '✅ Bestellung gesendet',
            'order_send_error_prefix' => 'Fehler beim Senden der Bestellung:',
            'validation_name_before_paypal' => 'Gib deinen Namen ein, bevor du mit PayPal bezahlst.',
            'bar_paypal_success_message' => 'Danke {name}! Die PayPal-Zahlung war erfolgreich, deine Bestellung ist bestätigt.',
            'bar_paypal_success_title' => '✅ Zahlung abgeschlossen',
            'bar_paypal_success_but_register_error' => 'Zahlung erfolgreich, aber Fehler bei der Registrierung der Bestellung:',
            'bar_paypal_show_receipt' => 'Zeige die PayPal-Quittung an der Theke.',
            'bar_paypal_generic_error' => 'Ein PayPal-Fehler ist aufgetreten. Du kannst trotzdem bestellen und bar bezahlen.',
            'bar_paypal_unavailable' => 'PayPal ist derzeit nicht verfügbar. Nutze "Bestellen und bar bezahlen".',
            'groups_page_title' => '📊 Gruppen & Phasen',
            'groups_not_published' => 'Gruppen noch nicht veröffentlicht.',
            'groups_not_published_phase' => 'Gruppen für diese Phase noch nicht veröffentlicht.',
            'phase_generic_name' => 'Phase',
            'tab_groups' => 'Gruppen',
            'tab_matches' => 'Spiele',
            ...
            'matches_not_available' => 'Spiele nicht verfügbar.',
            'matches_title' => '🏆 Spielplan',
            'filter_by_team' => '🔎 Nach Team filtern:',
            'all_teams_option' => 'Alle Teams',
            'no_matches_for_team' => 'Keine Spiele für das ausgewählte Team gefunden.',
            'table_header_group' => 'Gruppe',
            'table_header_date' => 'Datum',
            'table_header_time' => 'Zeit',
            'table_header_phase' => 'Phase',
            'table_header_match' => 'Spiel',
            'table_header_result' => 'Ergebnis',
            'scoreboard_button' => '📺 Anzeigetafel',
            'standings_title_knockout' => '📈 Tabelle',
            'standings_title_groups' => '📈 Gruppentabellen',
            'standings_not_available' => 'Tabelle noch nicht verfügbar.',
            'knockout_no_standings_intro' => 'Dies ist eine K.-o.-Phase: Es gibt keine klassische Tabelle. So wurde der Turnierbaum erstellt:',
            'knockout_sort_criterion' => '📊 Kriterium für die Team-Rangliste:',
            'knockout_avoid_rematch' => '🚫 Wiederholungen aus derselben Gruppe in der ersten Runde vermeiden:',
            'knockout_maximize_seed' => '🌟 Setzlisten möglichst weit auseinanderhalten:',
            'knockout_bracket_note' => 'Der Turnierbaum und die Spielergebnisse finden sich im Reiter "🏆 Spiele" / "Finalphase".',
            'yes_label' => 'Ja',
            'no_label' => 'Nein',
            'criterion_avg_points' => 'Durchschnittliche Punkte pro Spiel',
            'criterion_win_pct' => 'Sieg-%',
            'criterion_avg_quotient_diff' => 'Durchschnitt + Quotient + Diff',
            'standings_col_pos' => 'Pos',
            'standings_col_team' => 'Team',
            'standings_col_pt' => 'Pkt',
            'standings_col_played' => 'Sp',
            'standings_col_won' => 'S',
            'standings_col_drawn' => 'U',
            'standings_col_lost' => 'N',
            'standings_col_scored_soccer' => 'TF',
            'standings_col_conceded_soccer' => 'TG',
            'standings_col_scored_volley' => 'PF',
            'standings_col_conceded_volley' => 'PG',
            'standings_col_diff' => 'Diff',
            'teams_advance_per_group' => 'Teams pro Gruppe kommen weiter',
            'gallery_loading' => 'Fotos werden geladen...',
            'gallery_load_error' => 'Fehler beim Laden der Galerie',
            'gallery_connection_error' => 'Verbindungsfehler',
            'gallery_title' => '📸 Galerie',
            'gallery_empty' => 'Noch keine Fotos veröffentlicht.',
            'gallery_prev_photo' => 'Vorheriges Foto',
            'gallery_next_photo' => 'Nächstes Foto',
            'gallery_close_button' => 'Schließen',
            'final_phase_title' => 'Finalphase',
            'final_phase_not_generated' => 'Finalphase noch nicht erstellt.',
            'team1_label' => 'Team 1',
            'team2_label' => 'Team 2',
            'final_ranking_title' => 'Endtabelle',
            'final_ranking_not_available' => 'Endplatzierung nicht verfügbar.',
            'position_label' => 'Position',
            'tablescore_start' => '▶️ Starten',
            'tablescore_reset' => '🔄 Zurücksetzen',
            'tablescore_use_timeout' => 'AUSZEIT NEHMEN',
            'tablescore_next_set' => '⏭️ NÄCHSTER SATZ',
            'tablescore_reset_set' => '🔄 SATZ ZURÜCKSETZEN',
            'tablescore_next_half' => '⏭️ NÄCHSTE HALBZEIT',
            'tablescore_reset_half' => '🔄 HALBZEIT ZURÜCKSETZEN',
            'tablescore_whistle' => '🔊 SCHIEDSRICHTERPFIFF',
            'tablescore_horn' => '📯 SCHLUSSSIGNAL',
            'tablescore_pause' => '⏸️ Pause',
            'tablescore_match_not_found' => 'Fehler: Spiel nicht gefunden',
            'tablescore_load_error' => 'Fehler beim Laden des Spiels:',
            ...
            'print_studio_include_name' => 'Turniername auf dem Foto anzeigen',
            'print_studio_no_frame' => '🚫 Kein Rahmen',
            'print_studio_drag_hint' => '👆 Ziehe das Foto, um es im Rahmen zu verschieben',
            'print_studio_center' => '🎯 Zentrieren',
        ...
        'zh' => [
            ...
            'submit_button' => '提交报名',
            'no_teams_yet' => '暂无队伍报名',
            'teams_page_title' => '队伍管理',
            'teams_total' => '总计',
            'team_confirmed' => '已确认',
            'team_dummy' => '虚拟队伍',
            'team_avg_level' => '平均水平',
            'team_no_players' => '尚未输入队员',
            'bar_title' => '🍹 赛事酒吧',
            'fullscreen_shrink' => '返回缩小视图',
            'fullscreen_expand' => '全屏查看',
            'add_to_cart' => '添加',
            'cart_title' => '🛒 您的购物车',
            'cart_empty' => '购物车是空的。请从上方菜单添加商品！',
            'cart_each' => '每份',
            'cart_total' => '总计',
            'your_name_label' => '您的姓名',
            'placeholder_name_surname' => '姓名',
            'notes_optional_label' => '备注（可选）',
            'placeholder_order_notes' => '例如：不要冰',
            'pay_cash_order_button' => '💵 下单并现场支付',
            'newsletter_title' => '📬 保持更新',
            'newsletter_intro' => '订阅以接收赛事更新，即使您不报名队伍。只需填写电子邮件或电话（也可以两者都填）。',
            'label_email' => '电子邮件',
            'label_phone' => '电话',
            'newsletter_submit' => '订阅',
            'attendance_title' => '🎟️ 参加活动',
            'attendance_intro' => '不参赛但想来观赛？请在此登记您的到场信息，以便我们了解预计到场人数。',
            'label_full_name' => '姓名',
            'attendance_name_placeholder' => '您的姓名',
            'attendance_total_people' => '总共多少人（包括您本人）',
            'attendance_children' => '其中有多少儿童',
            'attendance_submit' => '确认参加',
            'payment_title' => '💰 支付费用',
            'payment_select_team' => '选择您的队伍',
            'payment_choose_team_option' => '-- 请选择队伍 --',
            'payment_who_paying' => '您现在为谁付款？',
            'payment_quota_selected' => '所选队员的费用',
            'payment_pay_cash_button' => '💵 我将现场向主办方支付现金',
            'contact_title' => '📞 联系组委会',
            'contact_intro' => '用于报告问题、提出请求或获取赛事信息。',
            'contact_no_contact' => '组委会尚未设置联系方式。',
            'contact_email_subject' => '报告/请求 - ',
            'contact_email_body' => '您好，

我写信是关于（发现的问题/请求/其他）：

',
            'contact_write_email' => '发送电子邮件',
            'contact_call' => '致电',
            'contact_write_whatsapp' => '通过WhatsApp联系',
            'payment_default_description' => '欢迎每位队员自愿贡献 {amount} 欧元，以帮助我们支付赛事费用（场地、裁判、茶点）。非常感谢！',
            'payment_already_paid_suffix' => '（已支付）',
            'payment_already_paid_msg' => '✅ 该队伍已支付费用，谢谢！',
            'payment_players_selected_label' => '已选队员',
            'payment_quota_label' => '费用',
            'payment_cash_label' => '现金',
            'payment_with_paypal_label' => '使用PayPal',
            'payment_paypal_fee_tooltip' => 'PayPal手续费（3.4% + 0.35欧元）仅在线支付时收取，以确保组织者收到全额费用',
            'payment_includes_fee_text' => '含 {fee} 欧元PayPal手续费',
            'validation_email_or_phone_required' => '请至少填写电子邮件或电话号码。',
            'validation_email_invalid' => '电子邮件无效。',
            'validation_phone_invalid' => '电话号码无效。',
            'validation_privacy_required' => '您必须接受隐私政策。',
            'newsletter_already_registered' => '✅ 您已订阅——联系方式已更新。',
            'newsletter_success' => '✅ 订阅成功！',
            'validation_name_required' => '请输入您的姓名。',
            'validation_email_required_valid' => '请输入有效的电子邮件。',
            'validation_phone_required_valid' => '请输入有效的电话号码。',
            'attendance_min_people' => '人数必须至少为1。',
            'attendance_children_exceed' => '儿童人数不能超过总人数。',
            'attendance_success' => '✅ 参加已确认，谢谢！',
            'attendance_spots_full' => '⚠️ 名额已满，无法再确认新的参加申请。',
            'attendance_spots_remaining' => '剩余名额',
            'payment_cash_confirmation_msg' => '好的，请现场直接将费用交给组织者——他们将为所选队员登记付款。',
            'payment_success_msg' => '✅ 支付完成，非常感谢！',
            'payment_success_but_register_error' => '支付成功，但登记时出错：',
            'paypal_generic_error' => '发生了PayPal错误。您仍然可以使用现金支付。',
            'paypal_unavailable' => 'PayPal暂时不可用。您可以使用现金支付。',
            'validation_name_for_order' => '请输入您的姓名以继续下单。',
            'cart_empty_alert' => '购物车是空的。',
            'order_error_prefix' => '错误：',
            'order_send_failed' => '订单提交失败',
            'order_sent_message' => '谢谢{name}！您的订单已收到。

请到柜台付款取货（总计：{total}欧元）。',
            'order_sent_title' => '✅ 订单已发送',
            'order_send_error_prefix' => '发送订单时出错：',
            'validation_name_before_paypal' => '请在使用PayPal支付前输入您的姓名。',
            'bar_paypal_success_message' => '谢谢{name}！PayPal支付成功，您的订单已确认。',
            'bar_paypal_success_title' => '✅ 支付完成',
            'bar_paypal_success_but_register_error' => '支付成功，但登记订单时出错：',
            'bar_paypal_show_receipt' => '请在柜台出示PayPal收据。',
            'bar_paypal_generic_error' => '发生了PayPal错误。您仍然可以下单并使用现金支付。',
            'bar_paypal_unavailable' => 'PayPal暂时不可用。请使用"下单并现场支付"。',
            'groups_page_title' => '📊 分组与阶段',
            'groups_not_published' => '分组尚未公布。',
            'groups_not_published_phase' => '此阶段的分组尚未公布。',
            'phase_generic_name' => '阶段',
            'tab_groups' => '分组',
            'tab_matches' => '比赛',
            'tab_standings' => '积分榜',
            'group_label' => '小组',
            'level_label_prefix' => '水平',
            'schedule_title' => '赛程',
            'matches_not_available' => '比赛信息暂不可用。',
            'matches_title' => '🏆 比赛赛程',
            'filter_by_team' => '🔎 按队伍筛选：',
            'all_teams_option' => '所有队伍',
            'no_matches_for_team' => '未找到所选队伍的比赛。',
            'table_header_group' => '小组',
            'table_header_date' => '日期',
            'table_header_time' => '时间',
            'table_header_phase' => '阶段',
            'table_header_match' => '对阵',
            'table_header_result' => '结果',
            'scoreboard_button' => '📺 计分板',
            'standings_title_knockout' => '📈 积分榜',
            'standings_title_groups' => '📈 小组积分榜',
            'standings_not_available' => '积分榜尚不可用。',
            'knockout_no_standings_intro' => '这是淘汰赛阶段：没有传统意义上的积分榜。以下是对阵表的编排方式：',
            'knockout_sort_criterion' => '📊 队伍排名标准：',
            'knockout_avoid_rematch' => '🚫 首轮避免同组重赛：',
            'knockout_maximize_seed' => '🌟 种子队尽量分开：',
            'knockout_bracket_note' => '对阵表和比赛结果可在"🏆 比赛"／"决赛阶段"标签中查看。',
            'yes_label' => '是',
            'no_label' => '否',
            'criterion_avg_points' => '场均积分',
            'criterion_win_pct' => '胜率',
            'criterion_avg_quotient_diff' => '平均值+净胜商+净胜分',
            'standings_col_pos' => '排名',
            'standings_col_team' => '队伍',
            'standings_col_pt' => '积分',
            'standings_col_played' => '场次',
            'standings_col_won' => '胜',
            'standings_col_drawn' => '平',
            'standings_col_lost' => '负',
            'standings_col_scored_soccer' => '进球',
            'standings_col_conceded_soccer' => '失球',
            'standings_col_scored_volley' => '得分',
            'standings_col_conceded_volley' => '失分',
            'standings_col_diff' => '净胜',
            'teams_advance_per_group' => '支队伍从每组晋级',
            'gallery_loading' => '正在加载照片...',
            'gallery_load_error' => '相册加载出错',
            'gallery_connection_error' => '连接错误',
            'gallery_title' => '📸 相册',
            'gallery_empty' => '目前尚未发布任何照片。',
            'gallery_prev_photo' => '上一张',
            'gallery_next_photo' => '下一张',
            'gallery_close_button' => '关闭',
            'final_phase_title' => '决赛阶段',
            'final_phase_not_generated' => '决赛阶段尚未生成。',
            'team1_label' => '队伍1',
            'team2_label' => '队伍2',
            'final_ranking_title' => '最终排名',
            'final_ranking_not_available' => '最终排名不可用。',
            'position_label' => '名次',
            'tablescore_start' => '▶️ 开始',
            'tablescore_reset' => '🔄 重置',
            'tablescore_use_timeout' => '使用暂停',
            'tablescore_next_set' => '⏭️ 下一局',
            'tablescore_reset_set' => '🔄 重置本局',
            'tablescore_next_half' => '⏭️ 下半场',
            'tablescore_reset_half' => '🔄 重置本半场',
            'tablescore_whistle' => '🔊 裁判哨声',
            'tablescore_horn' => '📯 比赛结束号角',
            'tablescore_pause' => '⏸️ 暂停',
            'tablescore_match_not_found' => '错误：未找到比赛',
            'tablescore_load_error' => '加载比赛时出错：',
            ...
            'print_studio_include_name' => '在照片上显示赛事名称',
            'print_studio_no_frame' => '🚫 无相框',
            'print_studio_drag_hint' => '👆 拖动照片以在相框内移动',
            'print_studio_center' => '🎯 居中',
...
// Cancella un torneo
/**
 * 🆕 Cancella una cartella e tutto il suo contenuto ricorsivamente, in PHP
 * puro — senza usare shell_exec()/exec(), spesso DISABILITATI per motivi
 * di sicurezza sull'hosting condiviso (causava "Call to undefined function
 * shell_exec()" quando si cercava di cancellare un torneo dal pannello
 * multi-tenant).
 */
